            ...
            <Row style={{
                ...
                <Col xs="3">
                    <Project title="Dragonfly" imgsrc={dragonflyimg}
                             desc="An ASCII art game engine capable of providing services to build 2D text-based video games. Built by me with the guidance of Professor Mark Claypool."
